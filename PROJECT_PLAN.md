...
## Milestone B — controlled AWS demonstration (in progress)
...
- [ ] Deploy and record the actual URL and region in `HANDOVER.md`
- [ ] Verify security-group access to port 8501 from the intended audience
